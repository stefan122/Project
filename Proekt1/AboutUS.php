...
<body>
	...
	<div id="nav" class="menu">
		<ul style="padding-left: 0px;">
			...
			<li><a class="zanas" href="../Proekt1/AboutUS.php">ЗА НАС</a></li>
	...
	<div id="main">
		...
		<div id="content">
			<div id="About">
				<h1 class="head1">За Нас</h1>
				<p class="Paragraf">
					 Од самиот почеток па се до ден денес нашата цел е да ги следиме потребите на нашите купувачи и да им одговориме на нивните барања и потреби. Компанијата има стабилен и динамичен раст и стана афирмиран бренд на македонскиот простор токму заради следењето на барањата на пазарот, решавање на дилемите на клиентите околу соодветен избор на материјали, остварување деловна соработка со реномирани глобални брендови од оваа област со цел во секое време да има најквалитетна понуда на канцелариска опрема на нашиот пазар.
				</p>
				<p class="Paragraf">
					Нашата основна мисија – високиот квалитет и високата професионалсност не водат до нашата крајната цел – задоволни клие
				</p>
				<p class="Paragraf">
					Нашата понуда вклучува секаков вид на канцелариски материјали, школски материјали, тонери, компјутерска галантерија, промо материјали, хигиена и тоа од најпознатите светски брендови.
				</p>
			</div>
		</div>
		<div id="discount">
